...
namespace Algorithms.GraphTests
{
    ...
    {
        private IGraph _undirectedGraph;
        IGraph _directedGraph;

        [TestInitialize]
        public void Initialise()
        {
            _undirectedGraph = new AdjacencyList(10, false);
            _directedGraph = new AdjacencyList(10, true);
        }
        ...
        [TestMethod]
        public void Add_Edge_Between_Zero_And_One_Assert_Are_Neighbours_And_Edge_Count2ForUndirected_CountOf1ForDirected()
        {
